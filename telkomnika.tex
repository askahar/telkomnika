...
\CopyrightLine[Copyright]{2019}{Universitas Ahmad Dahlan. All rights reserved.}
...
\shorttitle{A title should be the fewest possible words that accurately describe the ... (First Author)}

%%starting
\begin{document}
\setcounter{page}{1001} %set first page
...
%\issn{2302-4046}
\issn{1693-6930}
\DOI{10.12928/TELKOMNIKA.v16i4.9056}
